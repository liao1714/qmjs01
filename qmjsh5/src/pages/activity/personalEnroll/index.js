...
import { List, Badge, Picker, NavBar, WingBlank, InputItem, Checkbox, Toast, Modal } from 'antd-mobile'
...
class Personal extends Component {
    ...
    this.props.dispatch({ type:'activity/detail', payload: {pkId: this.props.location.query.evensId} }).then(res => {
      this.props.dispatch({type: 'activity/enrollItemCost', payload: { pkId: this.props.location.query.evensId }}).then(res => {
        if (res && res.code === 200) {
          ...
          this.props.dispatch({type: 'activity/personalEnrollForm', payload: { pkId: this.props.location.query.evensId }}).then(res => {
  ...
  render() {
    ...
    console.log(detail)
    return (
      <div className='personal-enroll-page'>
        <NavBar
          mode='light'
          leftContent={<div>
              ...
              <div className='enroll'>
                ...
                <div className='enroll-info'>
                  <div className='enroll-info-header'>
                    <div>报名信息</div>
                    <div className='desc'>报名成功将短信通知你，请准确填写信息，以便办理各种手续和购买保险</div>
                  </div>
        ...
        <div className='op-info'>
          ...
          <div className='enroll-op'>
            ...
            {/* <div className='enroll-op-right btn-md' onClick={ e=> this.enrollNow(this.customForms.getFieldsValue())}>立即报名</div> */}
